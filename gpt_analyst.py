...
- НИКАКИХ ШОРТОВ - только покупка и продажа в лонг
- Одна чёткая рекомендация (ПОКУПАТЬ / ЖДАТЬ / НЕ ВХОДИТЬ)
- Используй слова: "покупать", "продавать", "цель", "стоп-лосс"
- НЕ используй: "шорт", "лонг", "тейк", "профит", "бот", заголовки

СТРУКТУРА:
📊 + краткий анализ тренда и уровней (1 строка)
🤖 + сформирован ли автоматический сигнал (используй "автосигнал" или "условия") (1 строка)
💡 + ПОКУПАТЬ/ЖДАТЬ/НЕ ВХОДИТЬ + конкретные цены (2-3 строки)"""
